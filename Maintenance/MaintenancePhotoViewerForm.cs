...
{
    public class MaintenancePhotoViewerForm : Form
    {
        private readonly int maintenanceId;
        private FlowLayoutPanel flow;

        public MaintenancePhotoViewerForm(int maintenanceId)
        {
        ...
        private void LoadPhotos()
        {
            try
            {
                var dt = DatabaseHelper.ExecuteStoredProcedure("sp_GetMaintenancePhotos",
